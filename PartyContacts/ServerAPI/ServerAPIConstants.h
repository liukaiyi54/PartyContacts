...
extern const NSInteger kServerAPICodeNotLoggedIn;
extern const NSInteger kServerAPICodeCustomErrorMessage;
extern const NSInteger kServerAPICodeServerError;

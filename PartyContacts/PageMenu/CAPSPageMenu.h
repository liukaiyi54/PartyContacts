...
@property (nonatomic, assign) CGFloat icdMenuLeftMargin;
...
@property (nonatomic) UIColor *icdSelectedMenuItemLabelBackgroundColor;
...
extern NSString * const CAPSPageMenuOptionICDMenuLeftMargin;
extern NSString * const CAPSPageMenuOptionMenuHeight;
extern NSString * const CAPSPageMenuOptionSelectedMenuItemLabelColor;
extern NSString * const CAPSPageMenuOptionSelectedMenuItemLabelBackgroundColor;
